...
@dataclass
class TailorNetOutput(ModelOutput):
...
class TailorNet_Layer(nn.Module):
    ...
    def __init__(
        ...
        super(TailorNet_Layer, self).__init__()
    ...
    def forward_shape(
        ...
        return TailorNetOutput(vertices=v_shaped, betas=betas, v_shaped=v_shaped)
    ...
    def forward(
        ...
        output = TailorNetOutput(vertices=vertices if return_verts else None,
                            global_orient=global_orient,
                            body_pose=body_pose,
                            joints=joints,
                            betas=betas,
